package com.example.atp.presentation.register_student_screen
        ...
        Column(
            ...
            Row(
                ...
                Button(onClick = {
                    ...
                    Toast.makeText(ctx, "Ready to Register", Toast.LENGTH_SHORT).show()
                }) {
                    Text(text = "Register")
                }
            }
...
fun validate(
    ...
    else if (sem.all { it.isDigit() } && sem.toInt() !in 1..8) false to "Invalid Semester"
